      ...
      <section className="py-10 bg-michiganBlue">
        ...
        <div className='container mx-auto px-2 flex items-center content-between flex-col lg:flex-row gap-4'>
          ...
          <div className='lg:w-1/2'>
            ...
            <p className='mb-2'>My academic journey, encompassing a Master&rsquo;s in Business Analytics and a Bachelor’s in Banking and Finance, has provided me with a solid foundation in data analysis, financial modeling, and strategic decision-making. This combination of analytical and business acumen allows me to approach challenges with a holistic perspective, bridging the gap between data insights and actionable solutions.</p>
